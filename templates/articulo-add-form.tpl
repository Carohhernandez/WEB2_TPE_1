<form action="createArticulo" method="POST" id="formArticle" class='d-flex flex-column w-100'>
    ...
    <input type="text" name="imagen" placeholder="Direccion de la imagen" class='mb-2' required>
